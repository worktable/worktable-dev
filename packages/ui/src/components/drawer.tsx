...
function DrawerHandle({
  ...
  return (
    <DrawerPrimitive.Handle
      ...
      className={cn(
        "mx-auto mt-4 hidden h-1.5 w-[92px] shrink-0 rounded-full bg-muted transition-colors group-data-[vaul-drawer-direction=bottom]/drawer-content:block group-data-[vaul-drawer-direction=bottom]/drawer-content:active:bg-muted-foreground/45",
        className
      )}
      {...props}
    />
...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      className={cn(
        "dialog-backdrop fixed inset-0 z-50 supports-backdrop-filter:backdrop-blur-xs data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0",
        className
      )}
      {...props}
    />
